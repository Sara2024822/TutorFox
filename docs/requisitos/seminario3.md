...
ID 01: Cadastro e Perfil (Alta Prioridade)
...
ID 02: Flashcards de Memorização (Alta Prioridade)
...
Critério 3: Durante a prática, a resposta do card 
só deve ser revelado após o clique do usuário.


ID 03: Gerador de Resumo Aristotélico (Alta Prioridade)
...
ID 04: Central de Anexos (Alta Prioridade)
...
ID 06: Sistema de Revisão Espaçada (Média Prioridade)
...
ID 07: Organização por Matérias (Média Prioridade)
...
ID 08: Painel de Progresso (Média Prioridade)
...
ID 09: Cronômetro de Foco (Baixa Prioridade)
...
ID 10: Compartilhamento de Conteúdo (Baixa Prioridade)
...
ID 05: Interface Ágil e Responsiva (Alta Prioridade)
